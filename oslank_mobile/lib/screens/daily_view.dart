          ...
          if (_isLoading)
            ...
            Column(
              children: [
                _buildColoredCard(
                  title: "Total Revenue",
                  value: formatCurrency(_kpiData?['total_sales']),
                ...
                _buildColoredCard(
                  title: "Total Orders",
                  value: "${_kpiData?['total_orders'] ?? 0}",
                  subtitle: "Transaksi",
                  icon: Icons.shopping_bag_outlined,
                  colors: [const Color(0xFF4DB6AC), const Color(0xFF00897B)],
                ),
                _buildListCard(
                  title: "Penjualan per Grup Barang",
                  items: _groupDataList,
                  nameKey: "description",
                  valueKey: "total",
                ...
                _buildListCard(
                  title: "Perbandingan Costcenter",
                  items: _costcenterDataList,
                  nameKey: "description",
                  valueKey: "total",
                  icon: Icons.business_outlined,
                  colors: [const Color(0xFF9575CD), const Color(0xFF5E35B1)],
                ),
              ],
            ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text("Revenue Analysis", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      Row(
                        children: [
                  ...
                  Row(
                    children: [
                      SizedBox(
                        width: 140,
                        height: 140,
                        child: _buildCashierPieChart(),
                      ),
                      const SizedBox(width: 24),
                      Expanded(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: _cashierData.take(5).toList().asMap().entries.map((entry) {
                            int idx = entry.key;
                            var row = entry.value;
                            dynamic tVal = row['total'];
                            double val = tVal is String ? double.parse(tVal) : (tVal as num).toDouble();
                            double pct = _totalCashierSales > 0 ? (val / _totalCashierSales) * 100 : 0;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("${item['sales_name']} • ${item['entrydate'].toString().split(' ').first}", 
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isTunai ? const Color(0xFF10B981).withOpacity(0.1) : Colors.blue.withOpacity(0.1),
                                  borderRadius: BorderRadius.circular(10),
                                ),
                                child: Text(isTunai ? "TUNAI" : "KREDIT", 
                                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, 
                                  color: isTunai ? const Color(0xFF10B981) : Colors.blue)),
                              )
                            ],
                          )
                        ],
