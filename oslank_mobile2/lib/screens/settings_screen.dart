...
import 'dashboard_appearance_screen.dart';
        ...
        : ListView(
            ...
            children: [
              ...
              Container(
                ...
                child: ListTile(
                  leading: const Icon(Icons.dashboard_customize, color: Color(0xFFFF5C35)),
                  title: const Text("Customize Dashboard", style: TextStyle(fontWeight: FontWeight.bold)),
                  subtitle: const Text("Reorder, hide, or change widget colors"),
                  trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                  onTap: () async {
                    final res = await Navigator.push(context, MaterialPageRoute(builder: (_) => const DashboardAppearanceScreen()));
                    if (res == true) {
                      _needsRefresh = true;
                    }
                  },
